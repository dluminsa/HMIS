    ...
    if st.session_state.readery:
        ...
        'TI  ': 'TI', 'TO  ':'TO', 'DD  ': 'DD', 'AG  ':'AG', 'GD  ':'GD'})
            ...
            #        
                        ...
                        df['AGE BANDP'] = df['AG'].apply(ager1)
...
#MH DATA   3333333333333333333333333333333333333333333333333333
                        ...
                        m2map = {
                            ...
                            'Has signs and symptoms with Low/moderate suicide Risk': 'LF',
    ...
    if st.session_state.readery:# and st.session_state.dfw:
            ...
            output = io.BytesIO()
            mapperd = {'0-4':1, '5-9':2, '10-14':3, '15-19':4, '20-24':5, '25-29':6, '30-39':7, '40-49':8,'50+':9}
            
            mapperp = {'<1':1,'1-4':2, '5-9':3, '10-14':4, '15-19':5, '20-24':6, '25-29':7, '30-34':8, '35-39':9,
...
##########################################MENTAL HEALTH
            ...
            if not facility:
                            ...
                            st.download_button(
                                ...
                                data=output,
                                file_name=f"{facility}_NCDS_PIVOTS.xlsx",
