            ...
            #             #Clearing NaT from te dates
                        ...
                        if b11<1:
                            ...
                            if a3 > 0:
                                ...
                                dfc1 = dfcx1.groupby('WEIGHT BANDS')['ART'].size().reset_index().rename(columns={'ART': 'TOTAL'})
                            ...
                            if dfcpc.shape[0] >0:
                                ...
                                dfc6 = dfc6[~dfc6['WEIGHT BANDS'].isin(['25-29.9 KG', '>= 30 KG'])].copy()
                            ...
                            #st.write(df[['ART','VD', 'Vyear', 'Vmonth']])
